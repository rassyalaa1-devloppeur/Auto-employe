        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nom" name="nom" class="form-control"
                       value="<?php echo e(old('nom')); ?>" placeholder="Amrani" required>
                <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="prenom" name="prenom" class="form-control"
                       value="<?php echo e(old('prenom')); ?>" placeholder="Omar" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="matricule" name="matricule" class="form-control"
                       value="<?php echo e(old('matricule')); ?>" placeholder="EMP-00001" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="site" name="site" class="form-control"
                       value="<?php echo e(old('site')); ?>" placeholder="Casablanca" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="societe" name="societe" class="form-control"
                       value="<?php echo e(old('societe')); ?>" placeholder="Acme SA">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="departement" name="departement" class="form-control"
                       value="<?php echo e(old('departement')); ?>" placeholder="Informatique">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="categorie" name="categorie" class="form-control"
                       value="<?php echo e(old('categorie')); ?>" placeholder="Cadre">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="activite_fonction" name="activite_fonction" class="form-control"
                       value="<?php echo e(old('activite_fonction')); ?>" placeholder="Ingénieur">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\gestionemployé\resources\views/employes/create.blade.php ENDPATH**/ ?>